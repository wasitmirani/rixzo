...
import Header from '@/app/layouts/backend/partials/Header';
import Sidebar from '@/app/layouts/backend/partials/SideBarMenu';
...
<head>
        ...
        {/* <!-- MAIN JS --> */}
        <script src="/backend/assets/main.js"></script>
    ...
    <body>
                                ...
                                <div className="row switcher-style gx-0">
                                    <div className="col-4">
                                        <div className="form-check switch-select">
                                            ...
                                            <input className="form-check-input" type="radio" name="direction" id="switcher-ltr" checked />
                                        </div>
                                    </div>
                                    <div className="col-4">
                                        <div className="form-check switch-select">
        ...
        <script  src="/backend/assets/simplebar.js"></script>

        {/* <!-- PICKER JS --> */}
        <script src="/backend/assets/libs/flatpickr/flatpickr.min.js"></script>
        <script src="/backend/assets/libs/%40simonwep/pickr/pickr.es5.min.js"></script>

        {/* <!-- AUTO COMPLETE JS --> */}
        <script src="/backend/assets/libs/@tarekraafat/autocomplete.js/autoComplete.min.js"></script>
        ...
        <script  src="/backend/assets/ecommerce-dashboard-Diz2IHgQ.js"></script>


        {/* <!-- STICKY JS --> */}
        <script src="/backend/assets/sticky.js"></script>

        {/* <!-- APP JS --> */}
    <script  src="/backend/assets/app-Cnpnysuk.js"></script>

        {/* <!-- CUSTOM-SWITCHER JS --> */}
      <script  src="/backend/assets/custom-switcher-BX4z_p9X.js"></script>

        {/* <!-- END SCRIPTS --> */}
          {/* <!-- Toast JS --> */}
          <link rel="modulepreload" href="/backend/assets/toasts-CLr2vkjC.js" />
          <script type="module" src="/backend/assets/toasts-CLr2vkjC.js"></script>
